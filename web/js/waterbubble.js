    ...
    $.fn.waterbubble = function(options) {
        ...
        Waterbubble.prototype = {
            ...
            _buildShape: function (canvas, config) {
                ...
                if (config.animation) {
                    this._animate(ctx, r, data, lineWidth, waterColor, x, y, wave, config.txt, textColor, font, anterior);
                } else {
            ...
            _animate: function (ctx, r, data, lineWidth, waterColor, x, y, wave, txt, textColor, font, anterior) {
                var datanow = {
                    value: anterior
                };
				var goingUp;
                ...
                var update = function () {
					if (goingUp){
						...
						if (datanow.value > data) {
							datanow.value -= ((datanow.value + 0.05 - data)/15)
							self._runing = true;
						} else {
							self._runing = false;
						}
