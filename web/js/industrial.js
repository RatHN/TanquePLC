...
(function($) {
  ...
  $.fn.industrial = function(option) {
    return this.each(function() {
	  ...
	  if ( option < 80 && option > 20){
		data.$element.children(".meter").css({
			'background': '-webkit-linear-gradient(left, blue, rgba('+76+','+ 69+','+ 233+','+.75+'))'
		});
	} else if (option < 20 ){
		data.$element.children(".meter").css({
	    ...
	    data.$element.children(".meter").css({
	        'background': '-webkit-linear-gradient(left, orange, green)'
	    });
	}
